...
def main():
    ...
    # Native gold burnishes smooth where it is exposed; the boost is a
    # clear step up from the matrix, well short of a cut gem.
    rough_noise = lib.fbm(lib.SIZE, base_cells=20, octaves=3, seed=13)
    smooth = 0.5 * height + 0.55 * rough_noise + ore_t * 0.35
