"""Per stem PBR authoring script for mcl_colorblocks_concrete_powder_cyan.
...
if __name__ == "__main__":
    lines = concrete_powder_family.run("mcl_colorblocks_concrete_powder_cyan", sys.argv[1])
