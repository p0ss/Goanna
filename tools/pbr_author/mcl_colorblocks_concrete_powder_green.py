"""Per stem PBR authoring script for mcl_colorblocks_concrete_powder_green.
...
if __name__ == "__main__":
    lines = concrete_powder_family.run("mcl_colorblocks_concrete_powder_green", sys.argv[1])
