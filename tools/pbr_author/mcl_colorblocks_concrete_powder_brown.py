"""Per stem PBR authoring script for mcl_colorblocks_concrete_powder_brown.
...
if __name__ == "__main__":
    lines = concrete_powder_family.run("mcl_colorblocks_concrete_powder_brown", sys.argv[1])
