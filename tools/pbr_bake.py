...
def write_attribution(game_dir, out_dir, textures=None):
    ...
    # Name the game, not where it happens to be installed. This file ships
    # inside every published bundle, and an absolute path also publishes the
    # baking machine's home directory. Per mod paths below are already
    ...
    with open(os.path.join(out_dir, "ATTRIBUTION.md"), "w") as f:
        f.write("# Attribution for these maps\n\n"
                "Generated by tools/pbr_bake.py from the textures of the game\n"
                "`%s`.\n\n"
